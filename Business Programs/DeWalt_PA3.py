...
def windchill():
	while True:
		temp = input("Please enter a temperature in Fahrenheit(°F). Please use an integer: ")
		if temp.isdigit():
			break
		else:
			print()
	...
	print()
	while True:	
		wind_speed = input("Please enter a wind speed (mph). Please use an integer: ")
...
#This is where the user chooses a menu option:
while True:
